...
namespace MVCBasico.Controllers
{
    public class VeterinarioController : Controller
    {
        ...
        public VeterinarioController(VetAppDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Veterinario veterinario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Veterinario veterinario)
        {
